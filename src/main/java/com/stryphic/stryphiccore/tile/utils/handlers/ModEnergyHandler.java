package com.stryphic.stryphiccore.tile.utils.handlers;

import com.stryphic.stryphiccore.tile.utils.helpers.FaceData;
    ...
    public void updateEnergyOutput(TileEntity tileEntity, World world){
        ...
        for (FaceData face : faceData) {
            if (face.tileEntity != null) {
                IEnergyStorage cap = (IEnergyStorage) face.tileEntity.getCapability(
